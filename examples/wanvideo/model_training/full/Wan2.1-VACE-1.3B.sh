...
WANDB_PROJECT="VACE"
EXPERIMENT_NAME="Wan2.1-VACE-1.3B_full"
WANDB_MODE="online"
WANDB_RUN_ID=""
...
# Example:
# bash examples/wanvideo/model_training/full/Wan2.1-VACE-1.3B.sh --data_file_keys "video,vace_video,vace_video_mask,vace_reference_image" --extra_inputs "vace_video,vace_video_mask,vace_reference_image"
# With evaluation:
# bash examples/wanvideo/model_training/full/Wan2.1-VACE-1.3B.sh --eval_metadata_path "/path/to/eval_metadata.csv" --eval_steps 5000
