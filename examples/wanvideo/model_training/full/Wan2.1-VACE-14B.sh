...
# With evaluation:
# bash examples/wanvideo/model_training/full/Wan2.1-VACE-14B.sh --data_file_keys "video,vace_video,vace_video_mask,vace_reference_image" --extra_inputs "vace_video,vace_video_mask,vace_reference_image" --eval_metadata_path "/path/to/eval_metadata.csv" --eval_steps 5000
